...
stdenv.mkDerivation (finalAttrs: {
  ...
  buildInputs =
    ...
    ++ lib.optional (stdenv.hostPlatform.isAndroid && !useLLVM) stdenv.cc.cc.libgcc;
  ...
  ++ devExtraCmakeFlags
  ++ lib.optionals (stdenv.hostPlatform.isAndroid && !useLLVM) [
    (lib.cmakeFeature "CMAKE_EXE_LINKER_FLAGS" "-lgcc")
    (lib.cmakeFeature "CMAKE_SHARED_LINKER_FLAGS" "-lgcc")
  ];
